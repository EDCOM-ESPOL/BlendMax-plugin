...
class JobController extends Controller{
	...
	public function createJob($scene,$file_path,$frame_ini,$frame_fin,$flag){
        $date = time(); 
        ...
        $frame_final = (int) preg_replace('/[^0-9]/', '', $frame_fin);
            ...
            if($flag=="max"){
                $result = shell_exec('sh /opt/cgru/setuprender.sh; python "/opt/cgru/afanasy/python/maxjob.py" ' . escapeshellarg(json_encode($data)));
            }
            if($flag=="blend"){
